...
export name='CaioBononi7'
export email="danoninhobrlvl1@gmail.com"
export repositorio="https://github.com/CaioBononi7/flutter_api.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="turma-a-$(date +%Y%m%d)"
